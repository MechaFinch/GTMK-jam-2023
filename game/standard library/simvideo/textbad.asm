...
%define SCREEN 0xF002_0000
%define CHARACTER_SET 0xF003_4000
...
func_draw_character:
	...
	; LK = destination pointer
	MOVW L:K, SCREEN
	MOV A, D
	MOV D, 0
	ADD K, A		; col * CHARACTER_SIZE_PIXELS
	ADC L, D
	...
	ADD K, A		; row * SCREEN_WIDTH * CHARACTER_SIZE_PIXELS
	ADC L, D
...
.draw_loop:
	...
	ADD I, 2
	ICC J
	ADD K, (SCREEN_WIDTH - 4) & 0xFFFF
	ADC L, (SCREEN_WIDTH - 4) / 0x1_0000
